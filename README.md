...
| `holiday_sync` | 한국천문연구원 | 매월 1일 06:00 · 첫 기동 | 3 (작년 · 올해 · 내년) |
...
**성능 개선 (2026-09-25, `make bench` · API 직접 · p50)**

| 요청 | 개선 전 | 개선 후 (캐시 없음) | 개선 후 (캐시 적중) |
|---|---|---|---|
| 철도 분석 화면 · 서울→부산 90일 (3요청 동시) | 1,972ms | 약 190ms | 7.8ms |
| 날짜별 운행 · 서울→대전 | 1,508ms | 약 255ms | 6.2ms |
| 정시율 30일 · 서울→대전 | 300ms | — | 4.9ms |
| `rail.od_trips` 90일 (psql) | 574ms | 66ms (JIT 끔 94ms → 해시 조인) | — |
